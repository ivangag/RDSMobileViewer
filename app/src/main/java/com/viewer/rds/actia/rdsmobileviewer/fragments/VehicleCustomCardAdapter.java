 ...
 */
public class VehicleCustomCardAdapter extends BaseAdapter implements Filterable {

    private List<VehicleCustom> mItems;
    CardArrayAdapter mCardArrayAdapter;

    public VehicleCustomCardAdapter() {
        initItems();
    }

    public VehicleCustomCardAdapter(CardArrayAdapter cardArrayAdapter) {
        mCardArrayAdapter = cardArrayAdapter;
        initItems();
